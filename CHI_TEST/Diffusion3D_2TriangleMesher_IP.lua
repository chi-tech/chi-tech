...
chiPhysicsMaterialSetProperty(materials[1],THERMAL_CONDUCTIVITY,SINGLE_VALUE,100000.0)
...
chiDiffusionSetProperty(phys1,BOUNDARY_TYPE,2,DIFFUSION_DIRICHLET,0.2)
chiDiffusionSetProperty(phys1,BOUNDARY_TYPE,3,DIFFUSION_DIRICHLET,0.2)
