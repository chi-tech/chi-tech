...
chiMonteCarlonSetProperty(phys1,MCProperties.TALLY_MERGE_INTVL,1e6)
...
chiFFInterpolationSetProperty(cline,LINE_FIRSTPOINT,0.01,-1.0, 0.799)
chiFFInterpolationSetProperty(cline,LINE_SECONDPOINT,0.01,1.0, 0.799)
