...
PieceWiseLinearPolyhedronMapping::MakeInternalQuadraturePointData() const
{
...
PieceWiseLinearPolyhedronMapping::MakeFaceQuadraturePointData(size_t face_index) const
{
