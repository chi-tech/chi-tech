...
protected:
  ...
  std::vector<LinearBoltzmann::CellViewBase*>* grid_transport_view;
  LinearBoltzmann::Solver&     ref_solver;
...
public:
  ...
  LBSSweepChunkPWL(chi_mesh::MeshContinuum* vol_continuum,
                   ...
                   LinearBoltzmann::Solver& in_ref_solver,
  ...
  virtual void Sweep(chi_mesh::sweep_management::AngleSet* angle_set)
  {
    ...
    for (int cr_i=0; cr_i<num_loc_cells; cr_i++)
    {
      ...
      auto transport_view =
        (LinearBoltzmann::CellViewFull*)(*grid_transport_view)[cell->local_id];
