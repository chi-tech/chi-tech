...
chiMonteCarlonCreateSource(phys0,MCSrcTypes.RESIDUAL,1,fflist1[1],bsrc[1]);

chiMonteCarlonSetProperty(phys0,MCProperties.NUM_PARTICLES,5e5)
...
chiMonteCarlonSetProperty(phys2,MCProperties.TALLY_MULTIPLICATION_FACTOR,0.5*bsrc[1])
...
if (chi_location_id == 0) then
    local handle = io.popen("python3 ChiTest/RMC/Compare3.py")
end
