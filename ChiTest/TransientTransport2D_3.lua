...
vol0 = chiLogicalVolumeCreate(RPP,-L/16,L/16,-L/16,L/16,-L/16,L/16)
...
chiPhysicsTransportXSSet(xs_strong_fuel_micro, CHI_XSFILE, "ChiTest/xs_inf_k1_6_1g.cxs")
xs_weak_fuelA_micro = chiPhysicsTransportXSCreate()
chiPhysicsTransportXSSet(xs_weak_fuelA_micro, CHI_XSFILE, "ChiTest/xs_inf_critical_1g.cxs")
xs_weak_fuelB_micro = chiPhysicsTransportXSCreate()
chiPhysicsTransportXSSet(xs_weak_fuelB_micro, CHI_XSFILE, "ChiTest/xs_inf_weak2_1g.cxs")
