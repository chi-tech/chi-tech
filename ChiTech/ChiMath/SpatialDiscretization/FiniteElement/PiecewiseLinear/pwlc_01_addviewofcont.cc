...
//void chi_math::SpatialDiscretization_PWLC::PreComputeNeighborCellSDValues()
//{
//  //============================================= Unit integrals
//  {
//    using namespace chi_math::finite_element;
...
//        {
//          const auto& cell = ref_grid->cells[cell_gid];
//          const auto& cell_mapping = GetCellMapping(cell);
//
//          UIData ui_data;
//          cell_mapping.ComputeUnitIntegrals(ui_data);
//
//          using namespace std;
//          nb_fe_unit_integrals.insert(make_pair(cell_gid,move(ui_data)));
//        }
//
...
//
//          using namespace std;
//          nb_fe_vol_qp_data.insert(make_pair(cell_gid,move(qp_data_vol)));
//          nb_fe_srf_qp_data.insert(make_pair(cell_gid,move(qp_data_srf)));
//        }
//
