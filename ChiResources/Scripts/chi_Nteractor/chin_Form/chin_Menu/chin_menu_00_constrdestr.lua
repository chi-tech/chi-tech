--######################################################### Constructor
function MenuClass.New(name)
    local this=setmetatable({},MenuClass);
    MenuCount=MenuCount+1;
    
    local objName="Menu"..string.format("%03d",MenuCount);
    this.name=name;
    this.xpos=100;
    this.ypos=100;
    this.xSize=200;
    ...
    this.text=name;
    this.inputText="Menu"..string.format("%02d",MenuCount);
    r=this.fontColor[1];
    g=this.fontColor[2];
    b=this.fontColor[3];
    a=this.fontColor[4];
