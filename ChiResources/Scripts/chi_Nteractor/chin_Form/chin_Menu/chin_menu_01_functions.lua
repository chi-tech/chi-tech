--#########################################################
function MenuClass.ProcessEvents(this)
...
--#########################################################
function MenuClass.SetProperty(this,property,value)
...
--#########################################################
function MenuClass.SizeChanged(this)
...
--#########################################################
function MenuClass.Redraw(this)
...
--######################################################### Add list item
function MenuClass.AddListItem(this,text)
...
--######################################################### Selected event
function MenuClass.Selected(this)
...
--######################################################### Selected event
function MenuClass.DeSelected(this)
