                 ...
                 unsigned int f)
{
  ...
  {
    const auto& v0 = grid_->vertices[cell.vertex_ids_[0]];
    const auto& v1 = grid_->vertices[cell.vertex_ids_[1]];
...
//    Nv = 4;
    ...
    const auto& v0 = grid_->vertices[v0i];
    const auto& v1 = grid_->vertices[v1i];
