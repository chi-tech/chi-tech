 ...
 * \code
 * //  cylindrical
 * phys1 = chiLBSCurvilinearCreateSolver(LBSCurvilinearSteadyState.CYLINDRICAL)
 * //  spherical
 * phys1 = chiLBSCurvilinearCreateSolver(LBSCurvilinearSteadyState.SPHERICAL)
 * \endcode
 */
int chiLBSCurvilinearCreateSolver(lua_State *L)
{
  ...
  auto new_solver =
    std::make_shared<lbs_curvilinear::SteadyStateSolver>(coord_system_type, solver_name);
