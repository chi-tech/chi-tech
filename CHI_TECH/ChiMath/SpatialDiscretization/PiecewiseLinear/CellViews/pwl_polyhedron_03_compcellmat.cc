...
double PolyhedronPWLFEView::PreShape(int face_index, int side_index,
 ...
 * at a quadrature point*/
double PolyhedronPWLFEView::PreGradShape_x(int face_index,
                                           int side_index,
                                           int i)
{
  double value = 0.0;
 ...
 * at a quadrature point*/
double PolyhedronPWLFEView::PreGradShape_y(int face_index,
                                           int side_index,
                                           int i)
{
  double value = 0.0;
 ...
 * at a quadrature point*/
double PolyhedronPWLFEView::PreGradShape_z(int face_index,
                                           int side_index,
                                           int i)
{
  double value = 0.0;
...
void PolyhedronPWLFEView::PreCompute()
{
  // ==================================================== Precompute elements
