...
double PolyhedronPWLFEView::ShapeValue(const int i, const chi_mesh::Vector3& xyz)
{
...
void PolyhedronPWLFEView::ShapeValues(const chi_mesh::Vector3& xyz,
...
chi_mesh::Vector3 PolyhedronPWLFEView::GradShapeValue(const int i,
...
void PolyhedronPWLFEView::GradShapeValues(
  const chi_mesh::Vector3 &xyz,
