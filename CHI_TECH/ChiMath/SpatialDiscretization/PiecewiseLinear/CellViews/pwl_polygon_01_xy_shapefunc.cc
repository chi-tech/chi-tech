 ...
 * coordinates.*/
double PolygonPWLFEValues::ShapeValue(const int i, const chi_mesh::Vector3& xyz)
{
...
chi_mesh::Vector3 PolygonPWLFEValues::GradShapeValue(const int i,
...
void PolygonPWLFEValues::GradShapeValues(
  const chi_mesh::Vector3 &xyz,
