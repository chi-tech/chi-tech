...
double HexahedronMappingFE_PWL::ShapeValue(const int i, const chi_mesh::Vector3& xyz)
{
...
void HexahedronMappingFE_PWL::ShapeValues(const chi_mesh::Vector3& xyz,
...
chi_mesh::Vector3 HexahedronMappingFE_PWL::GradShapeValue(const int i,
...
void HexahedronMappingFE_PWL::GradShapeValues(
  const chi_mesh::Vector3 &xyz,
