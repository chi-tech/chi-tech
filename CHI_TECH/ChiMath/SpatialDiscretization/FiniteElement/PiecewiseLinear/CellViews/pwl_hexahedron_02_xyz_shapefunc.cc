...
double HexahedronPWLFEValues::ShapeValue(const int i, const chi_mesh::Vector3& xyz)
{
...
void HexahedronPWLFEValues::ShapeValues(const chi_mesh::Vector3& xyz,
...
chi_mesh::Vector3 HexahedronPWLFEValues::GradShapeValue(const int i,
...
void HexahedronPWLFEValues::GradShapeValues(
  const chi_mesh::Vector3 &xyz,
