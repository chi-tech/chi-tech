...
void PolygonPWLFEValues::InitializeAllQuadraturePointData(
...
void PolygonPWLFEValues::InitializeVolumeQuadraturePointData(
  chi_math::finite_element::InternalQuadraturePointData& internal_data)
{
...
void PolygonPWLFEValues::InitializeFaceQuadraturePointData(unsigned int face,
