...
double PolyhedronPWLFEValues::ShapeValue(const int i, const chi_mesh::Vector3& xyz)
{
...
chi_mesh::Vector3 PolyhedronPWLFEValues::GradShapeValue(const int i,
...
void PolyhedronPWLFEValues::GradShapeValues(
  const chi_mesh::Vector3 &xyz,
