...
void NPT_GROUPSET::BuildDiscMomOperator(int scatt_order)
{
...
void NPT_GROUPSET::BuildMomDiscOperator(int scatt_order)
{
  chi_mesh::MeshHandler*    mesh_handler = chi_mesh::GetCurrentHandler();
  chi_mesh::VolumeMesher*         mesher = mesh_handler->volume_mesher;
...
void NPT_GROUPSET::BuildSubsets()
{
  //=================================== Groupset subsets
