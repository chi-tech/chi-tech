...
class NPT_SWEEP_PWL_POLYGON : public chi_mesh::SweepManagement::SweepChunk
{
private:
...
public:
  //################################################## Constructor
  NPT_SWEEP_PWL_POLYGON(chi_mesh::MeshContinuum* vol_continuum,
  ...
  void Sweep(chi_mesh::SweepManagement::AngleSet* angle_set)
  {
    ...
    for (int cr_i=0; cr_i<num_loc_cells; cr_i++)
    {
      ...
      NPT_CELLVIEW_FULL* transport_view =
        (NPT_CELLVIEW_FULL*)(*grid_transport_view)[poly_cell->cell_local_id];
