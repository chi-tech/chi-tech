#include "CHI_MODULES/CHI_NPTRANSPORT/chi_nptransport.h"
#include "CHI_MODULES/CHI_NPTRANSPORT/SweepChunks/npt_sweepchunk_pwl_slab.h"
#include "CHI_MODULES/CHI_NPTRANSPORT/SweepChunks/npt_sweepchunk_pwl_polygon.h"
#include "CHI_MODULES/CHI_NPTRANSPORT/SweepChunks/npt_sweepchunk_pwl_polyhedron.h"
...
SweepChunk* CHI_NPTRANSPORT::SetSweepChunk(int group_set_num)
{
  //================================================== Obtain groupset
  ...
  else
  {
    chi_log.Log(LOG_ALLERROR)
      << "CHI_NPTRANSPORT::SetSweepChunk, failed. Could not establish "
