...
void CHI_NPTRANSPORT::InitWGDSA(NPT_GROUPSET *groupset)
{
...
void CHI_NPTRANSPORT::AssembleWGDSADeltaPhiVector(NPT_GROUPSET *groupset,
                                                  double *ref_phi_old,
                                                  double *ref_phi_new)
{
...
void CHI_NPTRANSPORT::DisAssembleWGDSADeltaPhiVector(NPT_GROUPSET *groupset,
                                                     double *ref_phi_new)
{
  int gsi = groupset->groups[0]->id;
  int gss = groupset->groups.size();
