...
int chi_diffusion::Solver::InitializePWLDGrpAgg(bool verbose)
{
  ...
  for (int gr=0; gr<G; gr++)
  {
    for (int i=0;i<pwld_local_dof_count; i++)
    {
      ...
      G_nodal_nnz_off_diag[ir] = nodal_nnz_off_diag[i];
    }
  }
