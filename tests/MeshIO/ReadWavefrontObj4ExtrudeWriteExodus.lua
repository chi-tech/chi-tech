...
umesh = chiUnpartitionedMeshFromWavefrontOBJ("tests/MeshIO/ReadWavefrontObj4.obj")
...
chiVolumeMesherSetProperty(EXTRUSION_LAYER, 12.0, 12, "Single Layer")
...
if master_export == nil then
    chiMeshHandlerExportMeshToExodus("ZExodus4a")
end
