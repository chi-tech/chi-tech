...
chiPhysicsTransportXSSet(xs["0"],CHI_XSFILE,"tests/Transport_Keigen/xs_water_g2.cxs")
chiPhysicsTransportXSSet(xs["1"],CHI_XSFILE,"tests/Transport_Keigen/xs_fuel_g2.cxs")
