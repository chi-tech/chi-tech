...
chiPhysicsTransportXSSet(xs["0"],CHI_XSFILE,"tests/BigTests/QBlock/xs_water_g2_bak.cxs")
chiPhysicsTransportXSSet(xs["1"],CHI_XSFILE,"tests/BigTests/QBlock/xs_fuel_g2_bak.cxs")
